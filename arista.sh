...
if command -v figlet &>/dev/null; then
    figlet -f slant "ARISTA"
fi
echo -e "${cyan}*****************************************${reset}"
echo -e "${cyan}*${reset} ${red}A${green}R${yellow}I${purple}S${cyan}T${green}A${reset} ${red}S${green}C${yellow}A${purple}N${cyan}N${green}E${red}R${reset}          ${cyan}"
echo -e "${cyan}*${reset} ${red}G${green}I${yellow}T${purple}H${cyan}U${green}B${reset} : ${purple}https://github.com/aristapanell-cell/AristaScanner${reset} ${cyan}"
echo -e "${cyan}*****************************************${reset}"
...
if [ "$user_input" -eq 1 ]; then
    ...
    bash <(curl -fsSL https://raw.githubusercontent.com/aristapanell-cell/AristaScanner/main/install.sh)
    echo -e "${green}After this, you can run the Arista with ${cyan}arista ${green}command${reset}"
else 
